<template>
  <div class="h-full min-h-screen w-full min-w-full">
        ...
        <div class="flex w-full flex-col">
          ...
          >
            <div class="flex flex-row justify-between items-center mb-6">
              <div
                class="flex flex-row items-center justify-start text-[#16A34A] text-2xl font-bold"
              >
    ...
    >
      <div
        class="flex flex-row justify-between items-center w-full h-auto mb-6"
      >
        <h2
          class="text-gray-500 font-semibold text-base md:font-bold md:text-2xl"
        >
          {{ $t("farmer_products") }}
        </h2>
        <h3
          @click="allFarmerProducts"
          class="inline-flex flex-row justify-center items-center w-auto text-gray-800 font-semibold text-base cursor-pointer"
        >
      ...
      <div class="flex w-full flex-col">
        <a-spin
          :spinning="useFarmerProductsStore().getProductsStatus !== 'success'"
          size="large"
          wrapper-class-name="text-green-800"
        >
          <products
    ...
    >
      ...
      >
        <button
          @click="loadMoreMostPurchasedProducts"
          class="px-8 py-1 rounded text-amber-400 border border-amber-400 hover:text-white bg-white hover:bg-amber-400 text-sm font-semibold"
        >
          {{ $t("more_products") }}
        </button>
