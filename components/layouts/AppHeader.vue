  ...
  <nav class="flex flex-col w-full bg-white">
    <div ref="navbar" class="w-full h-auto min-w-full z-50 bg-white">
      ...
      >
          ...
          <div class="flex flex-row justify-between items-center w-full h-auto">
            ...
            <div class="hidden lg:flex flex-row items-center">
              <a-tooltip placement="bottom">
                ...
                <div
                  @click="showFAQ"
                  class="flex flex-row items-center cursor-pointer ml-6"
                >
                  <question_icon />
                </div>
              </a-tooltip>
              ...
              <div class="mr-8">
                ...
                >
                  ...
                  <template #overlay>
                    <a-menu>
                      <a-menu-item
                        v-for="(language, index) in useLanguagesStore()
                          .getLanguages"
                        :key="index"
              ...
              <div>
                ...
                >
                  ...
                  <Login class="mx-1" />
                  <span
                    class="bg-[#0059FF] w-[7px] h-[7px] rounded-full"
                  ></span>
                </button>
                <div
                  v-else
                ...
                >
                  <a-dropdown :trigger="['click']">
                    <a
                      class="ant-dropdown-link text-gray-500 flex flex-row justify-between items-center cursor-pointer"
        ...
        <div
          class="flex flex-row lg:hidden relative h-14 items-center cursor-pointer mobile-box z-40"
        >
          <div>
            <a-tooltip placement="bottom">
              <template #title>
          ...
          <div
            @click="mobileMenu"
            class="relative inline-block w-6 h-6 bg-transparent overflow-hidden"
          >
            <span
              :class="{
                'mt-2 rotate-45': mobileMenuShow,
              }"
              class="absolute bg-black h-0.5 w-10 top-1 -left-1 block transform transition-all duration-200"
            ></span>
            <span
              :class="{
                'left-10': mobileMenuShow,
              }"
              class="absolute bg-black h-0.5 w-10 top-3 -left-1 block transform transition-all duration-200"
            ></span>
            <span
              :class="{
                '-mt-3.5 -rotate-45': mobileMenuShow,
              }"
              class="absolute bg-black h-0.5 w-10 top-5 -left-1 block transform transition-all duration-200"
            ></span>
          </div>
      ...
      <div class="hidden lg:flex items-center justify-between w-full h-auto">
        <ul
          class="flex flex-row justify-center items-center w-full m-0 bg-neutral-50 py-3"
        >
          <li @click="addQueryRouteProduct">
            <nuxt-link
              tag="a"
